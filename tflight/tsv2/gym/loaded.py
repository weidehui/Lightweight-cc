...
class LoadedModelAgent():
    ...
    def network_prune(self):
        ...
        k=0.2
        for i, weight in enumerate(trainable_variables):
            # print("i: ", i)
        ...
        #self.model.metagraph.get_layers()



def main():
    filename = '/home/huihui/tflight/tsv2/model-tf/jiandan-false-2-old'
    cwnd_use =0
    f = filename[cwnd_use]
    a = LoadedModelAgent(filename)
    a.network_prune()
